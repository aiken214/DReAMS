...
class SemiExpendableCardLvController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('supply.semi_expendable_card_lv.index', compact('id', 'data', 'item', 'description', 'office', 'amount', 'unit_price'));
    }

    public function getSemiExpendableCardLvs(Request $request)
    {                  
        // Fetch data
