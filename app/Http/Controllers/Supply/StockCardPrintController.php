...
class StockCardPrintController extends Controller
{
    public function print($id)
    {
        ...
        $table_data = RisItem::with(['ris', 'stocks'])->where('stock_card_id', $id)->get();

        return view('supply.print.stock_card', compact('id', 'data', 'table_data', 'item', 'description', 'office'));
    }
