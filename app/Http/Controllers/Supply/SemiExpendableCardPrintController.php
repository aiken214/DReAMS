...
class SemiExpendableCardPrintController extends Controller
{
    public function print_hv($id)
    {
        ...
        $table_data = RisItem::with(['ris', 'semi_expendables'])->where('semi_expendable_card_id', $id)->get();
        // dd($table_data);
        return view('supply.print.semi_expendable_card', compact('id', 'data', 'table_data', 'item', 'description', 'office', 'amount', 'unit_price'));
    }
