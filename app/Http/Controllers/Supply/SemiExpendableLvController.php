...
class SemiExpendableLvController extends Controller
{
    public function index()
    {
        abort_if(Gate::denies('semi_expendable_card_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    
        return view('supply.semi_expendable_lv.index');
    }

    public function getSemiExpendableLvs(Request $request)
    {                     
        // Fetch data
        $data = SemiExpendableCard::where('category', 'LVSE')->orderBy('id', 'asc')->get();
    ...
    public function show($id)
    {
        ...
        return view('supply.semi_expendable_lv.show', compact('semiExpendableCard'));
    }  
