...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class=" table table-bordered table-hover datatable" id="ics_itemTable">
                <thead>
                    <tr>
                        <!-- <th width="10">
...
<script>
    $(function () {
        ...
        let table = $('#ics_itemTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('api.semi_expendable_lv_received.index') }}?id='+id  + '&role=' + role, // Your API route
            ...
            columnDefs: [
                ...
                { className: 'dt-body-right', targets: [3, 5, 6, 9]},
