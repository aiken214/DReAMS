...
<script>
    $(function () {
        ...
        let ppmpTable = initializeDataTable('#ppmpTable', '{{ route('api.fund_ppmp_details.index') }}', [
        ...
        let purchase_requestTable = initializeDataTable('#purchase_requestTable', '{{ route('api.fund_pr_details.index') }}', [
            { data: null, defaultContent: "", orderable: false, className: 'select-checkbox' },
            { data: 'id', name: 'id' },
            { data: 'date', name: 'date' },
        ...
        let purchase_orderTable = initializeDataTable('#purchase_orderTable', '{{ route('api.fund_po_details.index') }}', [
            { data: null, defaultContent: "", orderable: false, className: 'select-checkbox' },
            { data: 'id', name: 'id' },
            { data: 'date', name: 'date' },
        ...
        let fund_obligationTable = initializeDataTable('#fund_obligationTable', '{{ route('api.fund_utilization_details.index') }}', [
