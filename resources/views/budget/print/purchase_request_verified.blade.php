        ...
        <div class="row">
          @can('ppmp_verify_access')
              <div style="margin-bottom: 10px;" class="row">
                  <div class="col-lg-12">
                      <a class="btn btn-default" href="{{ route('budget.purchase_request_verify.verified')}}">
                          {{ trans('global.back') }} 
                      </a>
                      <a class="btn btn-secondary" style="color: white;" onclick="printPage('test')">
                          {{ trans('global.print') }} {{ trans('global.verified') }} {{ trans('cruds.purchase_request.title_singular') }} {{ trans('global.list') }}
                      </a>
                  </div>
              </div>
          @endcan
          <div class="col-lg-12" style="margin-top: 20px;">
              ...
              <div id="test"> 
                    ...
                    <p style="text-align:center; font-size: 20px;"><b>List of Verified Purchase Request</b></p>
