...
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12">          
        <a class="btn btn-secondary text-white" id="viewButton">
            {{ trans('global.view') }} {{ trans('global.verified') }} {{ trans('cruds.purchase_request.title_singular') }} {{ trans('global.list') }}
        </a>
    </div>
</div>
<div class="card">
...
<script>
    ...
    $(function () {
        ...
        let table = $('#purchase_requestTable').DataTable({
            ...
            serverSide: true,    
            ajax: {
                url: '{{ route("api.purchase_request_verify.verified") }}',
                type: 'GET',
                data: function (d) {
...
$('#min, #max').on('change', function() {
        ...
        $(document).ready(function () {
            $('#viewButton').on('click', function () {
                ...
                var baseUrl = "{{ url('budget/verified_purchase_request_print') }}";
