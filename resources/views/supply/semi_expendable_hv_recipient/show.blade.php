...
<div class="card">
    ...
    <div class="row" style="margin:10px 2px 2px 20px;">
        <div class="col-auto">
            Recipient:<br>
            Position:<br>
            Station:
        ...
        <div class="col-auto">
            ...
            <strong>{{ $data->designation }}</strong><br>
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            ...
            <input type="hidden" name="hidden_recipient" id="hidden_recipient" value="{{ $data->recipient }}"/>   
        </div>
    </div>
</div>
<div class="form-group">
...
<script>
    var recipient = $('#hidden_recipient').val();   
...
<script>
    $(function () {
        ...
        let table = $('#ics_itemTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('api.semi_expendable_hv_recipient_item.index') }}?recipient='+recipient, // Your API route
            ...
            columnDefs: [
                ...
                { className: 'dt-body-right', targets: [4, 6, 7, 9]},
