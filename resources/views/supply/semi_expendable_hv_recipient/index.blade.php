...
$(function () {
        ...
        let table = $('#recipientTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('api.semi_expendable_hv_recipient.index') }}', // Your API route
                ...
                columns: [
                    ...
                    { data: 'entity_name'},
                    {
                        ...
                        render: function (data, type, row) {
                            return `
                                @can('recipient_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('supply.semi_expendable_hv_recipient.show', '') }}/${data}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan`;
                        }
