    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-secondary text-white" id="viewButton">
                {{ trans('global.view') }} {{ trans('cruds.regppei.title_short') }}
            </a>
        </div>
    </div>
@endcan
...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.regppei.title_singular') }} {{ trans('global.list') }}
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="typeFilter">
                                ...
                                @foreach(\App\Models\ParItem::SPECIFIC_TYPE_SELECT as $key => $value)
            ...
            <table class=" table table-bordered table-striped table-hover datatable" id="regspiTable">
                <thead>
                    <tr>
                        ...
                        <th rowspan='2' style="vertical-align:middle;">
                            {{ trans('cruds.regppei.fields.specific_type') }}
                        </th>
                        <th rowspan='2' style="vertical-align:middle;">
    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            $('#viewButton').on('click', function () {
                ...
                var baseUrl = "{{ url('supply/regppei_print') }}";
