...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("supply.iirusp_item.store") }}" enctype="multipart/form-data" id="create_form" >
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('date_acquired') ? 'is-invalid' : '' }}" type="text" name="date_acquired" id="date_acquired" value="{{ old('date_acquired', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea rows="5" class="form-control {{ $errors->has('particulars') ? 'is-invalid' : '' }}" type="text" name="particulars" id="particulars" value="{{ old('particulars', '') }}" required></textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('semi_expendable_property_no') ? 'is-invalid' : '' }}" type="text" name="semi_expendable_property_no" id="semi_expendable_property_no" value="{{ old('semi_expendable_property_no', '') }}" >
