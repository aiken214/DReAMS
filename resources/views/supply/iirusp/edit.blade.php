...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.iirusp.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("supply.iirusp.update", [$iirusp->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf          
            <div class="form-group">
                <label class="required" for="station">{{ trans('cruds.iirup.fields.station') }}</label>
                <input class="form-control {{ $errors->has('station') ? 'is-invalid' : '' }}" serviceability="text" name="station" id="station" value="{{ old('station', $iirusp->station) }}" readonly required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" serviceability="text" name="date" id="date" value="{{ old('date', $iirusp->date) }}" required>
                @if($errors->has('date'))
            ...
            <div class="form-group">
                ...
                <option value="{{ $iirusp->accountable_officer }}" selected>
            ...
            <div class="form-group">
                ...
                <option value="{{ $iirusp->position }}" selected>
                        {{ $iirusp->position }}
                    </option>
            ...
            <div class="form-group">
                ...
                <option value="{{ $iirusp->requester }}" selected>
                        {{ $iirusp->requester }}
                    </option>
                    @foreach($employees as $employee)
