...
<div class="card">
    <div class="card-header">
        <strong>{{ trans('cruds.par.title_singular') }} {{ 'Recipients' }} </strong>
    </div>
...
$(function () {
        ...
        let table = $('#recipientTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('api.ppe_recipient.index') }}', // Your API route
                ...
                columns: [
                    ...
                    { data: 'entity_name'},
                    {
                        ...
                        render: function (data, type, row) {
                            return `
                                @can('recipient_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('supply.ppe_recipient.show', '') }}/${data}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan`;
                        }
