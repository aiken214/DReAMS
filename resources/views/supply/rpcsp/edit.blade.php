...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.rpcsp.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("supply.rpcsp.update", [$rpcsp->id]) }}" enctype="multipart/form-data" id="edit_form" >
            @method('PUT')
            @csrf
            <input type="text" name="id" id="id" value="{{ $rpcsp->id }}" hidden> 

            <div class="form-group">
                <label class="required" for="article">{{ trans('cruds.rpcsp.fields.article') }}</label>
                <input rows="5" class="form-control {{ $errors->has('article') ? 'is-invalid' : '' }}" type="text" name="article" id="article" value="{{ old('article',  $rpcsp->article) }}" required></input>
            ...
            <div class="form-group">
                ...
                <textarea rows="5" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description"  required>{{ old('description', $rpcsp->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sp_property_no') ? 'is-invalid' : '' }}" type="text" name="sp_property_no" id="sp_property_no" value="{{ old('sp_property_no', $rpcsp->sp_property_no) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="text" name="type" id="type" required>
                    <option value disabled {{ old('type',  $rpcsp->type) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                    @foreach(App\Models\Rpcsp::TYPE_SELECT as $key => $label)
            ...
            <div class="form-group">
                ...
                <option value="{{ $rpcsp->unit }}" selected>
                        {{ $rpcsp->unit }}
                    </option>
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('unit_value') ? 'is-invalid' : '' }}" type="text" name="unit_value" id="unit_value" value="{{ old('unit_value', $rpcsp->unit_value) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('quantity_property_card') ? 'is-invalid' : '' }}" type="text" name="quantity_property_card" id="quantity_property_card" value="{{ old('quantity_property_card', $rpcsp->quantity_property_card) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('quantity_physical_count') ? 'is-invalid' : '' }}" type="text" name="quantity_physical_count" id="quantity_physical_count" value="{{ old('quantity_physical_count', $rpcsp->quantity_physical_count) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('quantity_so') ? 'is-invalid' : '' }}" type="text" name="quantity_so" id="quantity_so" value="{{ old('quantity_so', $rpcsp->quantity_so) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('value_so') ? 'is-invalid' : '' }}" type="text" name="value_so" id="value_so" value="{{ old('value_so', $rpcsp->value_so) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea rows="5" class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" type="text" name="remarks" id="remarks" required> {{ old('value_so', $rpcsp->remarks) }} </textarea>
