...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("supply.rpcsp.store") }}" enctype="multipart/form-data" id="create_form" >
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sp_property_no') ? 'is-invalid' : '' }}" type="text" name="sp_property_no" id="sp_property_no" value="{{ old('sp_property_no', '') }}" required>
