...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            ...
            <table class=" table table-bordered  table-hover datatable" id="rspiTable">
                <thead>
                    <tr>
                        <th>
...
<script>
    $(function () {
        ...
        let table = $('#rspiTable').DataTable({
            processing: true,
            serverSide: true,
            //ajax: '{{ route('api.rspi_hv.index') }}', // Your API route            
            ajax: {
                url: '{{ route("api.rspi_lv.index") }}',
                type: 'GET',
                data: function (d) {
        ...
        $(document).ready(function () {
            $('#viewButton').on('click', function () {
                ...
                var url = "{{ route('supply.rspi_lv_print', ['from' => ':from', 'to' => ':to']) }}";
