...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.asset_item.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("supply.asset_item.store") }}" enctype="multipart/form-data" id="create_form" >
            @csrf
            <input type="text" name="asset_id" id="asset_id" value="{{ $id }}" hidden> 
            <div class="form-group row add">
                ...
                <div class="position-relative w-100 p-2">
                    <input type="text" class="select_description form-control pl-4" 
                        id="select_description" list="asset_item" name="select_description" 
                    ...
                    <i class="fas fa-search position-absolute" style="left: 15px; top: 50%; transform: translateY(-50%); color: #888;"></i>
                        <datalist id="asset_item" name="asset_item" >                              
            ...
            <div class="form-group">
                <label class="required" for="description">{{ trans('cruds.asset_item.fields.description') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="stock_no">{{ trans('cruds.asset_item.fields.stock_no') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.asset_item.fields.stock_no_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="unit">{{ trans('cruds.asset_item.fields.unit') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.asset_item.fields.unit_helper') }}</span>
            </div>  
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="required" for="unit_price">{{ trans('cruds.asset_item.fields.unit_price') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.asset_item.fields.unit_price_helper') }}</span>
            </div>  
            <div class="form-group">
                <label class="required" for="amount">{{ trans('cruds.asset_item.fields.amount') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.asset_item.fields.amount_helper') }}</span>
            </div>    
            <div class="form-group">
...
<script>
    ...
    $(document).ready( function () {
        ...
        $("#select_description").change(function(){
            ...
            var value2send = document.querySelector("#asset_item option[value='" + shownVal + "']").dataset.value;
