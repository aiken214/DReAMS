          ...
          <div class="col-lg-12" style="margin-top: 20px;">
              ...
              <div id="test">
                ...
                <table style="width: 100%; margin: 0px 15px 0px 15px" cellspacing="0" cellspading="0">                    
                    <tr>
                        <td style="width: 65%">                    
                            <p style="text-align: left; vertical-align: top; font-size: 12px; margin-left: 5px">Entity Name: &nbsp;<b>{{ $data->ics_hv->entity_name }}</b></p> 
                        </td>
                        <td style="width: 35%"> 
                            <p style="vertical-align: top; font-size: 12px; margin-left: 20px">Date: &nbsp;<b>{{ $data->date }}</b>
                            <br>RRSP No.: &nbsp;<b>{{ $data->rrsp_hv_no }}</b></p>              
                        </td>
                    </tr>
                </table>
                <table style="width: 100%; margin: 10px 15px 10px 15px," cellspacing="0" cellspading="0">
                      ...
                      <tr>
                          <td style="padding-left: 5px; font-size: 14px; border: 1px solid black">{{ $data->ics_hv->Ics_item_hv->description }}</td>
                          <td style="text-align:center; font-size: 14px; border: 1px solid black">{{ $data->ics_hv->Ics_item_hv->quantity }}</td>                             
                          <td style="text-align:center;  font-size: 14px; border: 1px solid black">{{ $data->ics_hv->ics_hv_no }}</td> 
                          <td style="text-align:center;  font-size: 14px; border: 1px solid black">{{ $data->ics_hv->recipient }} <br> {{ $data->ics_hv->designation }} </td> 
                          <td style="padding-left: 5px; font-size: 14px; border: 1px solid black">{{ $data->ics_hv->Ics_item_hv->remarks }}</td>                                                               
                      </tr> 
                        ...
                        <td width="50%" style="font-size: 12px; border: 1px solid black">                    
                            ...
                            <div class="row justify-content-center" style="margin-top: 90px;">
                              <p style="text-align: center; font-size: 12px; margin: 1px; padding: 1px">
                                <b><u>{{ strtoupper($data->ics_hv->recipient) }}</u></b>
                                <br>End User                                                      
