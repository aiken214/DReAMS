        ...
        <div class="row">
          @can('ppmp_verify_access')
              <div style="margin-bottom: 10px;" class="row">
                  <div class="col-lg-12">
                      <a class="btn btn-default" href="{{ route('supply.ppmp_check.checked')}}">
                          {{ trans('global.back') }} 
                      </a>
                      <a class="btn btn-secondary" style="color: white;" onclick="printPage('test')">
                          {{ trans('global.print') }} {{ trans('global.checked') }} {{ trans('cruds.ppmp.title_singular') }} {{ trans('global.list') }}
                      </a>
                  </div>
              </div>
          @endcan
          <div class="col-lg-12" style="margin-top: 20px;">
              ...
              <div id="test"> 
                    ...
                    <p style="text-align:center; font-size: 20px;"><b>List of Checked PPMP</b></p>

                    <table style="width: 100%; margin: 0px 15px 0px 15px" cellspacing="0" cellspading="0">                    
                        <tr>
                            <td style="width: 50%">                    
                                <h5 style="text-align: left; font-size: 12px; margin-left: 20px">Entity Name: &nbsp;<b>DepEd Division of Davao del Norte - Property and Supply office</b></h5>                                                                          
                            </td>
                            <td style="width: 50%">                                       
