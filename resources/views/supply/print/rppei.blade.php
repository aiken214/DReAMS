        ...
        <div class="row">
          ...
          <div class="col-lg-12" style="margin-top: 20px;">
              ...
              <div id="test">
                ...
                <p style="text-align:center; font-size: 20px;"><b>Report of Plant, Property and Equipment Issued</b></p>
                ...
                <table style="width: 100%; margin: 10px 15px 10px 15px," cellspacing="0" cellspading="0">
                      ...
                      <tr>
                        ...
                        <tr>
                            <td style="width:14%; height:40px; text-align:center; font-size: 12px; border: 1px solid black"><b>PAR No.</b></td>
                            <td style="text-align:center; font-size: 12px; border: 1px solid black"><b>Responsibility<br>Center Code</b></td>
                            <td style="width:15%; text-align:center; font-size: 12px; border: 1px solid black"><b>Property No.</b></td>
                        ...
                        @foreach ($data as $datum)
                            <tr>
                                <td style="text-align:center; padding-left: 5px; font-size: 12px; border: 1px solid black">{{ $datum->par_no }}</td>
                                <td style="text-align:center; font-size: 12px; border: 1px solid black">01</td>   
                                <td style="text-align:center; font-size: 12px; border: 1px solid black">{{$datum->par_item->property_no }}</td> 
                                <td style="font-size: 12px; border: 1px solid black">{{$datum->par_item->description }}</td> 
                                <td style="text-align:center; font-size: 12px; border: 1px solid black">{{ $datum->par_item->quantity }}</td> 
                                <td style="text-align:center; padding-left: 5px; font-size: 14px; border: 1px solid black">{{ $datum->par_item->unit }}</td>                                                               
                                <td style="text-align:right; padding-right: 3px; font-size: 14px; border: 1px solid black">{{ number_format((float)$datum->par_item->amount, 2, '.', ',') }}</td>                   
                                <td style="text-align:right; padding-right: 3px; font-size: 14px; border: 1px solid black">{{ number_format((float)$datum->par_item->amount, 2, '.', ',') }}</td>                                                               
                            </tr>
                        @endforeach
