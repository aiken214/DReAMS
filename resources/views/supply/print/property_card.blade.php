        ...
        <div class="row">
          ...
          <div class="col-lg-12" style="margin-top: 20px;">
              ...
              <div id="test"> 
                    ...
                    <p style="text-align:center; font-size: 20px;"><b>Property Card</b></p>
                    ...
                    <table style="width: 100%; margin: 10px 15px 10px 15px," cellspacing="0" cellspading="0">
                        ...
                        <tr>
                            ...
                            <td rowspan = "2" style="width:14%; text-align:center; font-size: 12px; border: 1px solid black"><b>Reference</b></td>
                            <td rowspan = "2" style="width:6%; text-align:center; font-size: 12px; border: 1px solid black"><b>Receipt Qty</b></td>
                            <td colspan = "2" style="width:50%; text-align:center; font-size: 12px; border: 1px solid black"><b>Issue</b></td>                                 
                            <td rowspan = "2" style="width:6%; text-align:center; font-size: 12px; border: 1px solid black"><b>Balance Qty</b></td>                                 
                            <td rowspan = "2" style="width:14%; text-align:center; font-size: 12px; border: 1px solid black"><b>Amount</b></td>                 
                            <td rowspan = "2" style="width:14%; text-align:center; font-size: 12px; border: 1px solid black"><b>Remarks</b></td>                 
                        </tr>
                        <tr>
                            <td style="width:6%; text-align:center; font-size: 12px; border: 1px solid black"><b>Qty</b></td>
                            <td style="width:44%; text-align:center; font-size: 12px; border: 1px solid black"><b>Office/Officer</b></td>                 
                        </tr>
                        <tr>
                            ...
                            <td style="text-align:left; font-size: 12px; border: 1px solid black">{!! str_replace('/', '/<br>', $office) !!}</td>                                 
                            <td style="text-align:center; font-size: 12px; border: 1px solid black">{{ $data->receipt_quantity }}</th>                 
                            <td style="text-align:right; padding-left: 5px; font-size: 12px; border: 1px solid black">{{ number_format((float)$amount, 2, '.', ',') }}</td>
                            <td style="text-align:center; padding-left: 5px; font-size: 12px; border: 1px solid black">{{ $data->remarks }}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align:right; padding-left: 5px; font-size: 12px; border: 1px solid black">{{ number_format((float)$table_datum->properties->amount, 2, '.', ',') }}</td>                                 
                            <td style="text-align:center; padding-left: 5px; font-size: 12px; border: 1px solid black">{{ $table_datum->properties->remarks }}</td>                                 
                        </tr> 
                        @endforeach                               
                    </table>                             
                  </div>                                                             
