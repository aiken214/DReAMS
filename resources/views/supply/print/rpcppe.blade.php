            ...
            <div style="margin-bottom: 10px;" class="row">
                <div class="col-lg-12">
                    ...
                    <a class="btn btn-secondary" style="color: white;" onclick="printPage('test')">
                        {{ trans('global.print') }} {{ trans('cruds.rpcppe.title_short') }}
                    </a>
                </div>
            </div>
        @endcan
          <div class="col-lg-12" style="margin-top: 20px;">
            ...
            <div id="test"> 
              ...
              <p style="text-align:right; font-size: 12px;"><i>Appendix 73</i></p>                                    
              <p style="text-align:center; font-size: 20px; bottom-margin: 30px;"><b>REPORT ON THE PHYSICAL COUNT OF PROPERTY, PLANT AND EQUIPMENT</b></p>
              
              @isset($type)
                <p style="text-align:center; font-size: 16px; margin-bottom: 0px; padding-bottom: 0px;"><b>{{ $type }}</b></p>
                <p style="text-align:center; margin-top: 0px; padding-top: 0px; margin-bottom: 0px; padding-bottom: 0px; font-size: 10px;">(Type of Property, Plant and Equipment)</p>
              @endisset
