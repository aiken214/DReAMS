            ...
            <div style="margin-bottom: 10px;" class="row">
                <div class="col-lg-12">
                    ...
                    <a class="btn btn-secondary" style="color: white;" onclick="printPage('test')">
                        {{ trans('global.print') }} {{ trans('cruds.rpcsp.title_short') }}
                    </a>
                </div>
            </div>
        @endcan
          <div class="col-lg-12" style="margin-top: 20px;">
            ...
            <div id="test"> 
              ...
              <p style="text-align:center; font-size: 20px; bottom-margin: 30px;"><b>REPORT ON THE PHYSICAL COUNT OF SEMI-EXPENDABLE PROPERTY</b></p>
              
              @isset($type)
                <p style="text-align:center; font-size: 16px; margin-bottom: 0px; padding-bottom: 0px;"><b>{{ $type }}</b></p>
                <p style="text-align:center; margin-top: 0px; padding-top: 0px; margin-bottom: 0px; padding-bottom: 0px; font-size: 10px;">(Type of Semi-Expendable Property)</p>
              @endisset
                ...
                <table class="border table table-sm" id="table" style="font-size: 12px; text-align:center; vertical-align:middle">
                    <thead>
                        <tr>
                            ...
                            <th rowspan='2' style="vertical-align:middle; border: 1px solid #000000;">
                                {{ 'Semi-expendable' }} <br> {{ 'Property Number' }}
                            </th>
                            <th rowspan='2' style="vertical-align:middle; border: 1px solid #000000;">
                            ...
                            <th rowspan='2' style="vertical-align:middle; border: 1px solid #000000;">
                                {{ 'Quantity Per' }} <br> {{ 'Property Card' }}
                            </th>
                            <th rowspan='2' style="vertical-align:middle; border: 1px solid #000000;">
                                {{ 'Quantity Per' }} <br> {{ 'Physical Count' }}
                            </th>
                            <th colspan='2' style="text-align:center; border: 1px solid #000000;">
                                {{ __('Shortage/Overage') }}
                            </th>
                            <th rowspan='2' style="vertical-align:middle; border: 1px solid #000000;">
                    ...
                    <tbody>
                      @foreach ($items as $data)
                        <tr>
                            ...
                            <td style="border: 1px solid black">{{ $data->sp_property_no }}</td>
                            <td style="border: 1px solid black">{{ $data->unit }}</td>
                            <td class="pr-3" style="border: 1px solid black; text-align:right">{{ number_format((float) str_replace(',', '', $data->unit_value), 2, '.', ',') }}</td>
