        ...
        @endcan
          <div class="col-lg-12" style="margin-top: 20px;">
            ...
            <div id="test"> 
              ...
              <p style="text-align:center; font-size: 20px; bottom-margin: 30px;"><b>INVENTORY AND INSPECTION REPORT OF UNSERVICEABLE SEMI-EXPENDABLE PROPERTY</b></p>
              
              <p style="text-align:center; margin-top: 0px; padding-top: 0px; font-size: 12px;">As at <u><b>{{ \Carbon\Carbon::parse($iiruspData->date)->format('F j, Y') }}</b></u></p>
              ...
              <div class="row">
                  <div class="column" style="width:30%; text-align: center;">
                    <p style="font-size: 12px;"><b><u>{{ strtoupper($iiruspData->accountable_officer) }}</u></b><br>
                    <i>{{ '(Name of Accountable Officer)' }}</i></p>
                  </div>
                  <div class="column" style="width:30%; text-align: center;">
                    <p style="font-size: 12px;"> <b><u>{{ strtoupper($iiruspData->position) }}</u></b><br>
                    <i>{{ '(Designation)' }}</i></p>
                  </div>
                  <div class="column" style="width:30%; text-align: center;">
                      <p style="font-size: 12px;"><b><u>{{ strtoupper($iiruspData->station) }}</u></b><br>
                      <i>{{ '(Station)' }}</p>
                  </div>
              </div>     
                    ...
                    <tbody>
                      @foreach ($items as $data)
                        <tr>
                            ...
                            <td style="border: 1px solid black">{{ $data->semi_expendable_property_no }}</td>
                              ...
                              <div style="display: flex; justify-content: space-between; align-items: flex-start; padding: 0 10px;">
                                  ...
                                  <div style="width: 40%; text-align: center;">
                                      ...
                                      <p style="font-size: 12px;">
                                          <b><u>{{ strtoupper($iiruspData->requester) }}</u></b><br>
                                          Property Custodian
                                      </p>
                                  </div>
                                  ...
                                  <div style="width: 40%; text-align: center;">
                                      ...
                                      <p style="font-size: 12px;">
                                          <b><u>{{ strtoupper($iiruspData->accountable_officer) }}</u></b><br>
                                          School Head
                                      </p>
                                  </div>
                              </div>
