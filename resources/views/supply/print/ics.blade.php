              ...
              <div id="test">
                ...
                <table style="width: 100%; margin: 0px 15px 0px 15px" cellspacing="0" cellspading="0">                    
                    <tr>
                        ...
                        <td style="width: 40%"> 
                            <p style="text-align: center; vertical-align: top; font-size: 12px; margin-left: 20px">ICS No.: &nbsp;<b>{{ $data->ics_hv_no }} {{ $data->ics_lv_no }}</b></p>              
                        </td>
                    </tr>
                </table>
                <table style="width: 100%; margin: 10px 15px 10px 15px," cellspacing="0" cellspading="0">
                      ...
                      <tr>
                          ...
                          <td style="text-align:center; font-size: 14px; border: 1px solid black">{{ number_format((float)$table_datum->unit_cost, 2, '.', ',') }}</td> 
                          <td style="text-align:center; font-size: 14px; border: 1px solid black">{{ number_format((float)$table_datum->total_cost, 2, '.', ',') }}</td>                                   
                          <td style="padding-left: 5px; font-size: 14px; border: 1px solid black">{!! nl2br($table_datum->description) !!}<br>{{ 'S/N: ' }} {{ $table_datum->serial_no }}</td>                                                                                                    
                          @php
                            $data1 = $table_datum->inventory_item_no; 
                          ...
                          <td style="text-align:center; font-size: 14px; border: 1px solid black">{{ $table_datum->lifespan }}</td>                                   
                      </tr> 
                      @endforeach
