...
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12">          
        <a class="btn btn-secondary text-white" id="viewButton">
            {{ trans('global.view') }} {{ trans('global.checked') }} {{ trans('cruds.ppmp.title_singular') }} {{ trans('global.list') }}
        </a>
    </div>
</div>
<div class="card">
...
<script>
    ...
    $(function () {
        ...
        let table = $('#ppmpTable').DataTable({
            ...
            serverSide: true,            
            ajax: {
                url: '{{ route("api.ppmp_check.checked") }}',
                type: 'GET',
                data: function (d) {
                    ...
                    render: function (data, type, row) {
                        return `@can('ppmp_check_show')
                            ...
                            @can('ppmp_check_access')
                                ${(row.checked !== null && row.checked === null && row.remarks !== 'Request for PPMP reversal - End User.') ? `                                    
        ...
        $(document).ready(function () {
            $('#viewButton').on('click', function () {
                ...
                var baseUrl = "{{ url('supply/checked_ppmp_print') }}";
