...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("supply.iirup_item.store") }}" enctype="multipart/form-data" id="create_form" >
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('property_no') ? 'is-invalid' : '' }}" type="text" name="property_no" id="property_no" value="{{ old('property_no', '') }}" >
