...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.iirup_item.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("supply.iirup_item.update", [$iirupItem->id]) }}" enctype="multipart/form-data" id="edit_form" >
            @method('PUT')
            @csrf   
            <input type="text" name="id" id="id" value="{{ $iirupItem->id }}" hidden>      
            <div class="form-group">
                <label class="required" for="date_acquired">{{ trans('cruds.iirup_item.fields.date_acquired') }}</label>
                <input class="form-control {{ $errors->has('date_acquired') ? 'is-invalid' : $iirupItem->id }}" type="text" name="date_acquired" id="date_acquired" value="{{ old('date_acquired', $iirupItem->date_acquired) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea rows="5" class="form-control {{ $errors->has('particulars') ? 'is-invalid' : $iirupItem->id }}" type="text" name="particulars" id="particulars" required>{{ old('particulars', $iirupItem->particulars) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('property_no') ? 'is-invalid' : $iirupItem->id }}" type="text" name="property_no" id="property_no" value="{{ old('property_no', $iirupItem->property_no) }}" >
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('quantity') ? 'is-invalid' : $iirupItem->id }}" type="text" name="quantity" id="quantity" value="{{ old('quantity', $iirupItem->quantity) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('unit_cost') ? 'is-invalid' : $iirupItem->id }}" type="text" name="unit_cost" id="unit_cost" value="{{ old('unit_cost', $iirupItem->unit_cost) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('total_cost') ? 'is-invalid' : $iirupItem->id }}" type="text" name="total_cost" id="total_cost" value="{{ old('total_cost', $iirupItem->total_cost) }}" readonly required>
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('depreciation') ? 'is-invalid' : $iirupItem->id }}" type="text" name="depreciation" id="depreciation" value="{{ old('depreciation', $iirupItem->depreciation) }}" >
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('losses') ? 'is-invalid' : $iirupItem->id }}" type="text" name="losses" id="losses" value="{{ old('losses', $iirupItem->losses) }}" >
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('carrying_amount') ? 'is-invalid' : $iirupItem->id }}" type="text" name="carrying_amount" id="carrying_amount" value="{{ old('carrying_amount', $iirupItem->carrying_amount) }}" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('remarks') ? 'is-invalid' : $iirupItem->id }}" type="text" name="remarks" id="remarks" value="{{ old('remarks', $iirupItem->remarks) }}" >
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('sale') ? 'is-invalid' : $iirupItem->id }}" type="text" name="sale" id="sale" value="{{ old('sale', $iirupItem->sale) }}" >
                @if($errors->has('sale'))
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('transfer') ? 'is-invalid' : $iirupItem->id }}" type="text" name="transfer" id="transfer" value="{{ old('transfer', $iirupItem->transfer) }}" >
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('destruction') ? 'is-invalid' : $iirupItem->id }}" type="text" name="destruction" id="destruction" value="{{ old('destruction', $iirupItem->destruction) }}" >
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('others') ? 'is-invalid' : $iirupItem->id }}" type="text" name="others" id="others" value="{{ old('others', $iirupItem->others) }}" >
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('total_dispose') ? 'is-invalid' : $iirupItem->id }}" type="text" name="total_dispose" id="total_dispose" value="{{ old('total_dispose', $iirupItem->total_dispose) }}" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('or_no') ? 'is-invalid' : $iirupItem->id }}" type="text" name="or_no" id="or_no" value="{{ old('or_no', $iirupItem->or_no) }}" >
                @if($errors->has('or_no'))
            ...
            <div class="form-group">
                ...
                <input class="form-control numbers numbers_format {{ $errors->has('amount') ? 'is-invalid' : $iirupItem->id }}" type="text" name="amount" id="amount" value="{{ old('amount', $iirupItem->amount) }}" >
